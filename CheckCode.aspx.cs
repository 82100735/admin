...
public partial class CheckCode : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        PublicFunction.SetTableInfo("t_checkcode", "value = '"+ code.ToUpper() +"'","name = 'register'");// 使用Session取验证码的值
    ...
    #region 自定义背景色(默认白色)
    Color backgroundColor = Color.MediumTurquoise;
    ...
    string codeSerial = "2,3,4,5,6,7,8,9,A,B,C,E,F,G,H,J,K,L,M,N,P,Q,R,S,T,W,X,Y,Z";
    ...
    public System.Drawing.Bitmap TwistImage(Bitmap srcBmp, bool bXDir, double dMultValue, double dPhase)
    {
        ...
        graph.FillRectangle(new SolidBrush(System.Drawing.Color.MediumTurquoise), 0, 0, destBmp.Width, destBmp.Height);
        graph.Dispose();
